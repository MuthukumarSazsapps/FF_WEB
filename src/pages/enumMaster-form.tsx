...
import { EnumMasterFormDefaultValues, EnumMasterFormFieldTypes, EnumMasterFormSchema } from 'utils/types';
                    ...
                    {({ register, control, setValue, getValues, trigger, formState: { errors } }) => {
                        return (
                            <>
                                ...
                                <div>
                                    <Button label="create" type='submit' color='success' className='flex items-center w-20' isLoading={loading} />
                                </div>
                            </>
                        );
                    }}
